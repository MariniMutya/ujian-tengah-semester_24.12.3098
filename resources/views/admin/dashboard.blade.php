...
<main class="flex-1 overflow-y-auto">
    <div class="max-w-7xl mx-auto p-6 lg:p-10">
        ...
        <header class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-6">
            <div>
                <h1 class="text-3xl md:text-4xl font-black">Dashboard Ringkasan</h1>
        ...
        <div class="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden mt-6">
            <div class="px-6 py-5 border-b d-flex flex-row justify-between items-center">
                <h3 class="font-black text-lg">Transaksi Terakhir</h3>
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y border-t">
                        <tr class="hover:bg-slate-50 transition">
                            ...
                            <td class="px-6 py-5 font-medium text-slate-600">Jazz Night 2024</td>
                            <td class="px-6 py-5">
                                <span
                                    class="px-3 py-1 bg-green-100 text-green-700 rounded-lg text-xs font-bold uppercase">Success</span>
                            </td>
                            <td class="px-6 py-5 font-black text-indigo-600">Rp 155.000</td>
                        </tr>
                        <tr class="hover:bg-slate-50 transition">
                            <td class="px-6 py-5">
                            ...
                            <td class="px-6 py-5 font-medium text-slate-600">AI & Future Workshop</td>
                            <td class="px-6 py-5">
                                <span
                                    class="px-3 py-1 bg-orange-100 text-orange-700 rounded-lg text-xs font-bold uppercase">Pending</span>
                            </td>
                            <td class="px-6 py-5 font-black text-indigo-600">Rp 55.000</td>
                        </tr>
                        <tr class="hover:bg-slate-50 transition">
                            <td class="px-6 py-5">
                            ...
                            <td class="px-6 py-5 font-medium text-slate-600">Hackathon 2024</td>
                            <td class="px-6 py-5">
                                <span
                                    class="px-3 py-1 bg-slate-100 text-slate-600 rounded-lg text-xs font-bold uppercase">Free</span>
                            </td>
                            <td class="px-6 py-5 font-black text-indigo-600">Rp 0</td>
                        </tr>
                    </tbody>
                </table>
            </div>
